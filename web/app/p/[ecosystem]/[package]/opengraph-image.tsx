...
export default async function OpengraphImage({
  ...
  params: { ecosystem: string; package: string };
}) {
      ...
      (
        ...
        >
          ...
          <div style={{ display: "flex", fontSize: 22, color: "#64748b" }}>
            packagesafe.dev/p/{result.ecosystem}/{result.package}
          </div>
        </div>
      ),
      { ...size }
      ...
      (
        ...
        >
          ...
          <div style={{ display: "flex", fontSize: 28, color: "#64748b" }}>
            {notFound ? `'${packageName}' was not found in ${ecosystem}` : "Unable to scan this package"}
          </div>
        </div>
      ),
      { ...size }
